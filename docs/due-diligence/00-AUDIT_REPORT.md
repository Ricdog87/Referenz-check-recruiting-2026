...
- ✅ **Phase 5 — Release-Hygiene:** `CHANGELOG.md` (Keep-a-Changelog), Version `0.3.0` in `package.json` (Tag `v0.3.0` beim Merge nach `main`), echtes Top-Level-`README.md` (Stack/Quickstart/Flags/CI/Prinzipien; CV-Analyzer-Doku nach `docs/cv-analysis.md` verschoben), CI-Required-Checks in README dokumentiert (3 Gates in Branch-Protection zu aktivieren).
