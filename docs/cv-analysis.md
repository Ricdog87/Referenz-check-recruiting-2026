...
> Modul-Referenz für `lib/cv-analysis/`. Projekt-Überblick im
> [Top-Level-README](../README.md); DD-Datenraum in
> [`docs/due-diligence/`](due-diligence/README.md).

This document describes the backend module that helps human reviewers identify factual CV fabrication and consistency risks.
