...
const data: KeywordPageData = {
  ...
  hero: {
    ...
    sub: 'Ein Reference Check ist nur so belastbar wie das Gespräch dahinter. candiq führt Reference Checks mit geschulten Reviewern am Telefon durch, holt die Einwilligung des Kandidaten sauber nach DSGVO ein und liefert Ihnen einen strukturierten Report — typischerweise in unter 48 Stunden, gehostet in Deutschland.',
  },
  sections: [
    {
    ...
    },
    {
      h2: 'So läuft es ab',
      paragraphs: [
        'Anfrage in 30 Sekunden anlegen, Kandidat benennt im Portal selbst seine Referenzgeber und willigt ein, geschulte Reviewer telefonieren mit standardisierten Fragen, Sie erhalten den PDF-Report mit Bewertung pro Station und Diskrepanz-Markierung. Express-Option in 24 Stunden verfügbar.',
      ],
    },
  ],
  faq: [
    ...
    { q: 'Telefonisch oder per E-Mail?', a: 'candiq telefoniert mit geschulten Reviewern — kein anonymes E-Mail-Formular.' },
