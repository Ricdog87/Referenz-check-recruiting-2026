...
// FAQ-Plaintext für FAQPage-JSON-LD (GEO + Rich Results).
...
const HOMEPAGE_FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: 'Wie schnell ist der erste Report da?', a: 'Der Report liegt in unter 48 Stunden ab freigegebenem Auftrag vor (Express-Option: 24 Stunden). Beim allerersten Mal kommt das Onboarding hinzu - vom Kennenlern-Termin über die Bewerber-Einladung bis zum ersten Report sind es typischerweise rund 7 Tage. Danach läuft jede weitere Prüfung in unter 48 Stunden.' },
  ...
  { q: 'Was passiert mit den Daten nach dem Hire?', a: 'Ein automatischer Cron-Job löscht alle Bewerber-Daten 180 Tage nach Abschluss (Status COMPLETED, REJECTED oder CONSENT_REVOKED) - inkl. CV, Dokumente und Referenz-Antworten. Audit-Logs bleiben gemäß gesetzlicher Nachweispflicht nach Paragraph 257 HGB / Art. 7 DSGVO. Sie koennen jederzeit manuell frueher löschen via Dashboard-Self-Service.' },
  ...
  { q: 'Was kostet ein einzelner Refcheck?', a: 'Ein Einzel-Refcheck ohne Paket-Bindung kostet 49 Euro netto. Im 5er-Pack 39,80 Euro (199 Euro Bundle, 19 % guenstiger), im 10er-Pack 34,90 Euro (349 Euro Bundle, 29 % guenstiger). Pakete sind 12 Monate gültig. Volumen-Kunden erhalten zusaetzliche Rabatte.' },
  { q: 'Wie funktionieren Datenexport und Recht auf Vergessenwerden?', a: 'Beides Self-Service im Dashboard. Art. 20 DSGVO (Datenportabilitaet): Sie exportieren alle Daten eines Kandidaten als JSON+PDF per Klick. Art. 17 DSGVO (Löschung): gleicher Self-Service, mit Bestätigungs-Dialog, der gesetzlich aufbewahrungspflichtige Datensaetze markiert. Bewerber koennen ihre Einwilligung ausserdem jederzeit selbst widerrufen.' },
  { q: 'Was passiert mit dem CV, den wir hochladen?', a: 'Der CV ist ein personenbezogenes Datum des Bewerbers. Ihr seid Verantwortlicher, candiq Auftragsverarbeiter (AVV nach Art. 28). Wir verarbeiten den CV nur weisungsgebunden in eurem Auftrag, auf Servern in Deutschland, und löschen ihn automatisch nach spätestens 6 Monaten.' },
  { q: 'Dürfen wir als Kunde den CV hochladen, oder muss das der Bewerber tun?', a: 'Beides geht. Der Bewerber kann seinen CV selbst im Self-Service-Portal hochladen, oder ihr ladet ihn hoch. In beiden Faellen gilt dieselbe Regel: Geprüft wird erst, nachdem der Bewerber eingewilligt hat. Laedt der Kunde den CV hoch, geht automatisch ein Einladungslink an den Bewerber - erst nach seiner Freigabe bekommt ein Reviewer Zugriff.' },
  { q: 'Brauchen wir eine Einwilligung des Bewerbers?', a: 'Ja, und candiq holt sie strukturiert ein. Der Bewerber erteilt die Einwilligung selbst über einen Magic-Link, sieht transparent, was geprüft wird, wählt die Scopes (Stationen / Referenzgeber / CV-Abgleich) granular und nennt seine Referenzgeber selbst. Ihr klickt nie stellvertretend "der Kandidat hat zugestimmt". Audit-Trail mit Zeit, IP und Consent-Version inklusive (Art. 7 Abs. 1).' },
  { q: 'Was, wenn der CV ein Foto, Religion oder Gesundheitsdaten enthaelt?', a: 'Unsere Reviewer prüfen ausschließlich nachprüfbare Fakten - Position, Zeitraum, Aufgaben. Geschuetzte Merkmale (Herkunft, Religion, Gesundheit etc.) werden für die Prüfung nicht bewertet, AGG-konform. Besondere Kategorien aus dem CV fliessen nicht in die Bewertung ein.' },
  { q: 'Wo liegen die Daten und wie lange?', a: 'Server in Deutschland (EU-Region Frankfurt). Auto-Löschung nach spätestens 6 Monaten (Art. 5 Abs. 1 e). Widerruf jederzeit per Link (Art. 7 Abs. 3). AVV nach Art. 28 standardmäßig inklusive.' },
]
