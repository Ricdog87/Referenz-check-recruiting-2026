...
export const CANDIDATE_STATUS = {
  ...
  CONSENT_GIVEN: { label: 'Einwilligung erteilt', color: 'bg-emerald-50 text-emerald-700 border border-emerald-200' },
  ...
  CONSENT_REVOKED: { label: 'Einwilligung widerrufen', color: 'bg-rose-50 text-rose-700 border border-rose-200' },
...
export const AGENCY_PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Unbegrenzte Mandanten (Roadmap Q4 2026)',
      'White-Label & eigene Domain (Roadmap Q4 2026)',
      'REST-API für ATS-Integration (heute live)',
      'PDF-Reports per Knopfdruck (heute live)',
      'Native ATS-Konnektoren: Personio, Greenhouse (Roadmap Q4 2026)',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'REST-API ohne Limits (heute live, OAuth/API-Keys Q4 2026)',
      'Bulk-Upload CSV/Excel (Roadmap Q4 2026)',
      'Multi-Mandanten-Trennung + Sub-Brands (Roadmap Q4 2026)',
