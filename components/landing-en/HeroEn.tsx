      ...
      <motion.div style={{ opacity: fadeOut }} className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
        <motion.div style={{ y: textY }}>
          ...
          >
            ...
            <span className="text-text-primary">For HR teams · GDPR-compliant · EU-hosted</span>
          </motion.div>
          ...
          >
            <span className="block">Candidates who look perfect</span>
            <span className="block">on paper —</span>
            <span className="block"><span className="text-gradient-brand">but are they really?</span></span>
          </motion.h1>
          ...
          <div className="text-xs text-text-muted mb-10">
            15-min call · personal test access · GDPR-compliant · EU-hosted
          </div>
          ...
          >
            {[
              { icon: Clock3, k: 'Under 48 hours', v: 'From request to report' },
              { icon: FileCheck2, k: 'Structured report', v: 'Verified · Discrepancies · Notes' },
              { icon: BadgeCheck, k: 'Real conversations', v: 'Trained reviewers, no bots' },
            ].map(({ icon: Icon, k, v }) => (
