    ...
    >
      <div className="h-14 flex items-center px-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <Link href="/dashboard" className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-lg bg-accent flex items-center justify-center flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(10,132,255,0.3)' }}>
            <span className="text-white text-[10px] font-bold">RC</span>
          </div>
          <div>
            <div className="text-sm font-semibold text-white/90">RefCheck</div>
            <div className="text-[10px] text-white/30 truncate max-w-[120px]">Demo Workspace</div>
          </div>
        </Link>
      </div>
      ...
      <div className="p-2.5" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/[0.03]">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-medium text-white/80 truncate">Demo Benutzer</div>
            <div className="text-[10px] text-white/30 truncate">demo@refcheck.de</div>
          </div>
        </div>
      </div>
    </aside>
